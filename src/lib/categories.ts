...
export const CATEGORIES: CategoryMeta[] = [
  ...
  },
  {
    ...
    label: "Sandwich & wrap",
    color: "#F5A623",
    icon: '<path d="M3.5 12.5c0-4 3.8-7 8.5-7s8.5 3 8.5 7"/><path d="M3.5 12.5h17L19 18a2 2 0 0 1-2 1.6H7A2 2 0 0 1 5 18l-1.5-5.5z"/><path d="M6.5 12.5v-1M12 12.5v-1M17.5 12.5v-1" stroke-dasharray="0"/>',
  },
];
